...
//     self.timelable.frame=CGRectMake(WIDTH5S(40), 35, WIDTH5S(100), HEIGHT5S(13));
//     self.images.frame=CGRectMake(10, 10, WIDTH5S(30), HEIGHT5S(30));
//     self.commentlable.frame=CGRectMake(10, 40, WIDTH5S(300), HEIGHT5S(_d));
...
//     
//     CGRect textSize = [text boundingRectWithSize:CGSizeMake(300, 9999) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:12]} context:nil];
//     
